...
const W2Form: React.FC<W2FormProps> = ({ individual, w2, fontFamily = "'Courier New', monospace" }) => {
  return (
    <div
      className="w2-report"
      id="w2-report"
          ...
          <div className="w2-top-section">
            ...
            <div className="w2-left-column">
              <div className="w2-box w2-box-a">
                ...
                <div className="w2-box-value">{individual.ssn}</div>
              </div>
              ...
              <div className="w2-box-group-horiz">
                <div className="w2-box w2-box-b">
                  ...
                  <div className="w2-box-value">{individual.employerEIN}</div>
                </div>
              </div>
              ...
              <div className="w2-box w2-box-d">
                ...
                <div className="w2-box-value">{w2.controlNumber || ''}</div>
              </div>

              <div className="w2-box w2-box-e">
                <div className="w2-box-label">e Employee's first name and initial</div>
                <div className="w2-box-value">{individual.firstName} {individual.middleInitial}</div>
              </div>
            ...
            <div className="w2-right-header">
              ...
              <div className="w2-form-number-box">
                ...
                <div className="w2-year-box">{w2.taxYear}</div>
          ...
          <div className="w2-numbered-boxes">
            ...
            <div className="w2-box-row">
              <div className="w2-box w2-box-1">
                ...
                <div className="w2-box-value">{w2.wages}</div>
              </div>
              <div className="w2-box w2-box-2">
                <div className="w2-box-label">2 Federal income tax withheld</div>
                <div className="w2-box-value">{w2.federalIncomeTaxWithheld}</div>
              </div>
            </div>
            ...
            <div className="w2-box-row">
              <div className="w2-box w2-box-3">
                ...
                <div className="w2-box-value">{w2.socialSecurityWages}</div>
              </div>
              <div className="w2-box w2-box-4">
                <div className="w2-box-label">4 Social security tax withheld</div>
                <div className="w2-box-value">{w2.socialSecurityTaxWithheld}</div>
              </div>
            </div>
            ...
            <div className="w2-box-row">
              <div className="w2-box w2-box-5">
                ...
                <div className="w2-box-value">{w2.medicareWages}</div>
              </div>
              <div className="w2-box w2-box-6">
                <div className="w2-box-label">6 Medicare tax withheld</div>
                <div className="w2-box-value">{w2.medicareTaxWithheld}</div>
              </div>
            </div>
            ...
            <div className="w2-box-row">
              <div className="w2-box w2-box-7">
                ...
                <div className="w2-box-value">{w2.socialSecurityTips || ''}</div>
              </div>
              <div className="w2-box w2-box-8">
                <div className="w2-box-label">8 Allocated tips</div>
                <div className="w2-box-value">{w2.allocatedTips || ''}</div>
              </div>
            </div>
            ...
            <div className="w2-box-row">
              ...
              <div className="w2-box w2-box-10">
                ...
                <div className="w2-box-value">{w2.dependentCareBenefits || ''}</div>
              </div>
            </div>
            ...
            <div className="w2-box-row">
              <div className="w2-box w2-box-11">
                ...
                <div className="w2-box-value">{w2.nonqualifiedPlans || ''}</div>
              </div>
              <div className="w2-box-12-13-wrapper">
                <div className="w2-box w2-box-12">
                  ...
                  <div className="w2-box-12-codes">
                    {w2.box12Codes && w2.box12Codes.map((item, index) => (
